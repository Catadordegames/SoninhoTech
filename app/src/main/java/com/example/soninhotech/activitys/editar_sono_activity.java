...
public class editar_sono_activity extends AppCompatActivity {

    private EditText editInicio, editFim;
    private Button btnSalvar;
    private ImageButton btnVoltar;
    private RegistroSono registro;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.editar_sono_activity);
        ...
        // Recupera objeto
        registro = (RegistroSono) getIntent().getSerializableExtra("registro");
